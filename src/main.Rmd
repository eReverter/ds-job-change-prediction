...
prop.table(table(outilers$gender))


prop.table(table(df$relevent_experience))
prop.table(table(outilers$relevent_experience))

prop.table(table(df$enrolled_university))
prop.table(table(outilers$enrolled_university))

prop.table(table(df$education_level))
prop.table(table(outilers$education_level))

prop.table(table(df$major_discipline))
prop.table(table(outilers$major_discipline))

prop.table(table(df$last_new_job))
prop.table(table(outilers$last_new_job))
